...
mf_IHC_cFos <- function(Folder_name = "", Path, File_type = "csv", 
                         ...
                         Countlimits = c(0, 4000), Countbreaks = c(0, 1000, 2000, 3000, 4000),
                         Arealimits = c(0, 100), Areabreaks = c(0, 20, 40, 60, 80, 100),
                         Luminancelimits = c(0, 40), Luminancebreaks = c(0, 10, 20, 30, 40),
                         REDintensitylimits = c(0, 180), REDintensitybreaks = c(0, 30, 60, 90, 120, 150, 180),
                         Histmaxlimits_y = c(0, 0.08), Histmaxbreaks_y = c(0.00, 0.02, 0.04, 0.06, 0.08),
                         Histmaxlimits_x = c(0, 100), Histmaxbreaks_x = c(0, 20, 40, 60, 80, 100),
                         Histmeanlimits_y = c(0, 0.20), Histmeanbreaks_y = c(0.00, 0.05, 0.10, 0.15, 0.20),
                         Histmeanlimits_x = c(0, 50), Histmeanbreaks_x = c(0, 10, 20, 30, 40, 50),
